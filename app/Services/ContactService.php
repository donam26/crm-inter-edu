...
class ContactService
{
    public function create(Customer $customer, array $data): Contact
    {
        return DB::transaction(function () use ($customer, $data) {
            // Service-layer injection: customer_id và branch_id luôn lấy từ Customer cha,
            ...
            // chỉ có duy nhất 1 primary trên mỗi customer.
    ...
    public function update(Contact $contact, array $data): Contact
    {
        return DB::transaction(function () use ($contact, $data) {
            // Chặn override customer_id / branch_id qua input người dùng.
            unset($data['customer_id'], $data['branch_id']);
    ...
    public function setPrimary(Contact $contact): void
    {
        DB::transaction(function () use ($contact) {
            // Bypass BranchScope để đảm bảo reset toàn bộ contact của customer
